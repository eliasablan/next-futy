  ...
  return (
    <aside
      className={cn(
        ...
        'fixed inset-y-0 left-0 z-30 flex min-h-svh w-52 transform flex-col justify-between border-r transition duration-200 ease-out lg:inset-0 lg:translate-x-0',
