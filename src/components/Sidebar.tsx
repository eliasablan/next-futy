...
export function Sidebar({ leagues }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'no-scrollbar fixed inset-y-0 left-0 z-10 flex min-h-svh w-[4.5rem] transform flex-col justify-between space-y-6 overflow-y-scroll border-r bg-background transition duration-200 ease-out lg:inset-0 lg:translate-x-0 lg:overflow-y-visible',
