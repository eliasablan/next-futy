  ...
  return (
    <>
      {/* <section className="flex w-full flex-col px-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="mt-6 flex flex-col md:-mx-1 md:mt-0 md:flex-row">
          <button className="rounded-lg px-6 py-3 text-gray-500 transition-colors duration-300 hover:bg-gray-400 hover:text-white focus:outline-none md:mx-1">
          ...
          <button className="mt-4 rounded-lg bg-blue-600 px-6 py-3 text-white hover:bg-blue-500 focus:outline-none md:mx-1 md:mt-0">
            <div className="-mx-1 flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mx-1 h-5 w-5"
      ...
      <section className="grid grid-cols-1 gap-8 px-6 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        <div className="flex items-center rounded-lg bg-white px-6 py-8 shadow-md shadow-gray-200">
        ...
        <div className="flex items-center rounded-lg bg-white px-6 py-8 shadow-md shadow-gray-200">
          <div className="-mx-2 flex items-center">
            ...
            <div className="mx-2">
              <h3 className="text-2xl font-medium text-gray-800">6.8</h3>
              <p className="mt-1 text-sm text-gray-500">Average mark</p>
            </div>
          </div>
        </div>
        <div className="flex items-center rounded-lg bg-white px-6 py-8 shadow-md shadow-gray-200">
          <div className="-mx-2 flex items-center">
            ...
            <div className="mx-2">
              <h3 className="text-2xl font-medium text-gray-800">
                9 <span className="text-xl text-gray-600">(14%)</span>
              </h3>
        ...
        <div className="flex flex-col justify-center gap-x-8 gap-y-4 rounded-lg bg-white px-8 py-6 shadow-md shadow-gray-200 md:col-span-2 md:row-span-2">
          <div className="sm:flex sm:items-center sm:justify-between">
            <h2 className="font-medium text-gray-700">
              The number of applied and left students per month
            </h2>
            <div className="-mx-2 mt-4 flex items-center sm:mt-0">
              <span className="flex items-center text-gray-600">
                <p className="mx-2">Applied</p>
                <span className="mx-2 h-2 w-2 rounded-full bg-orange-500"></span>
              </span>
              <span className="flex items-center text-gray-600">
                <p className="mx-2">Left</p>
                <span className="mx-2 h-2 w-2 rounded-full bg-indigo-500"></span>
              </span>
            </div>
          </div>
          <canvas
            className="max-h-96 max-w-3xl"
            id="secondChart"
            style={{
              display: 'block',
            ...
            // style="display: block; box-sizing: border-box; height: 383.889px; width: 767.778px;"
            width="1382"
            height="691"
          ></canvas>
        </div>
        <div className="row-span-3 rounded-lg bg-white shadow-md shadow-gray-200">
          <div className="border-b border-gray-100 px-6 py-5 sm:flex sm:items-center sm:justify-between">
            ...
            <button
              type="button"
              className="mt-2 inline-flex justify-center rounded-lg bg-white text-sm font-medium leading-5 text-gray-500 hover:text-gray-600 focus:outline-none sm:mt-0"
            >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <Image
                  ...
                  className="h-10 w-10 overflow-hidden rounded-full bg-gray-100 object-cover"
                  width={40}
                  height={40}
        ...
        <div className="rounded-lg bg-white shadow-md shadow-gray-200 lg:row-span-2">
          ...
          <div className="flex items-center p-8">
            <canvas
              ...
              // style="display: block; box-sizing: border-box; height: 418.889px; width: 383.889px;"
              width="691"
              height="754"
            ></canvas>
          </div>
